-- ===================================
-- TRAILKEEPER CHAT SYSTEM - APPLY ONLY
-- ===================================
-- This script only adds the chat system tables without modifying existing structure

-- Enable real-time for chat functionality (only add if not exists)
DO $$
BEGIN
    BEGIN
