...
export interface UIState {
  currentView: 'list' | 'map' | 'timeline' | 'budget' | 'settings' | 'discovery' | 'search' | 'landing' | 'photos';
  activeView?: 'list' | 'map' | 'timeline' | 'budget' | 'settings' | 'discovery' | 'search' | 'landing' | 'photos';
